$(document).ready(function(){
    App.Setting = (function(){
        ...
        var URI = {
            ...
            sendlatest  : App.BaseUrl + 'api/common/sendlatest',
            sendoldest  : App.BaseUrl + 'api/common/sendoldest',
        ...
        me.bindingCate = function(){
            ...
            me.cate.dataAdapter = new $.jqx.dataAdapter(me.cate.source, {
                ...
                formatData: function (data) {
                    data.type = App.Setting.settings[App.Setting.sid].data.catetype || '';
                    return data;
                },
        ...
        me.bindingEntry = function(){
            ...
            if(!!!App.Setting.settings[App.Setting.sid].data.catetype){
            ...
            if(App.Setting.settings[App.Setting.sid].data.showthumb=='true'){
            ...
            me.dataAdapter = new $.jqx.dataAdapter(me.source, {
                formatData: function (data) {
                    data.type = App.Setting.settings[App.Setting.sid].data.type || '';
                    data.table = App.Setting.settings[App.Setting.sid].data.storage;
                    data.showthumb = App.Setting.settings[App.Setting.sid].data.showthumb;
                    return data;
                },
                loadError: function(xhr, status, error) {
                    toastr.error("<b>Status</b>:" + xhr.status + "<br/><b>ThrownError</b>:" + error + "<br/>",'Error');
            ...
            if(!!!App.Setting.settings[App.Setting.sid].data.catetype){
                ...
                me.columns[4] = {
                    ...
                    hidden: !!!App.Setting.settings[App.Setting.sid].data.catetype,
        ...
        return {
            ...
            Back: function(){
                if(!!App.Setting.settings[App.Setting.sid].data.size){
            ...
            ShowDetailDialog: function(id){
                if(!!App.Setting.settings[App.Setting.sid].data.size){
                    ...
                    dialog = new App.Dialog({
                        ...
                        'title': '<h4>Add <small>'+App.Setting.settings[App.Setting.sid].title+'</small></h4>',
                        'dialogClass':'',
                        'width': App.Setting.settings[App.Setting.sid].data.size,
                        'type':'notice',
                        'hideclose':true,
                        'closeOnEscape':false,
