$(document).ready(function(){
    App.Setting = (function(){
        ...
        var URI = {
            ...
            subdetail  : App.BaseUrl + 'api/setting/subdetail',
            commit  : App.BaseUrl + 'api/setting/commit',
            sendlatest  : App.BaseUrl + 'api/setting/sendlatest',
            sendoldest  : App.BaseUrl + 'api/setting/sendoldest',
            update  : App.BaseUrl + 'api/setting/update',
