$(document).ready(function(){
    App.Common = (function(){
                ...
                cellsrenderer: function (row, columnfield, value, defaulthtml, columnproperties) {
                    ...
                    if (value && value > 0) {
                        try {
                            ...
                            'data-toggle="dropdown" data-target="#menu"'+
                            " "+ 
        ...
        function createGrid(){
            ...
            $('body').append('<ul id="menu" class="dropdown-menu">\
                <li data-action="add"><a href="#"><i class="fa fa-plus"></i> Add new Record</a></li>\
                <li data-action="edit"><a href="#"><i class="fa fa-pencil-square"></i> Edit Selected Row</a></li>\
                <li data-action="delete"><a href="#"><i class="fa fa-trash-o"></i> Delete Selected Row</a></li>\
                <li role="separator" class="divider"></li>\
                <li data-action="status">\
                    <a href="#"><i class="fa fa-toggle-off"></i> Status</a>\
                </li>\
                <li data-action="view"><a href="#"><i class="fa fa-eye"></i> View Selected Row</a></li>\
                <li data-action="chart"><a href="#"><i class="fa fa-line-chart"></i> Chart</a></li>\
            </ul>')
