$(document).ready(function(){
    App.Module = (function(){
        var URI = {
            binding : App.BaseUrl + 'api/module/bind',
            detail  : App.BaseUrl + 'api/module/detail',
            commit  : App.BaseUrl + 'api/module/commit',
            delete  : App.BaseUrl + 'api/module/delete',
        };
        var gridElm = $('#jqxGrid');
        var theme = 'metro';
        var datafields = [
            ...
            ShowDetailDialog: function(id){
                ...
                new App.Request({
                    ...
                    if(res.code < 0){
                        ...
                        initGroup([{
                            name: 'Information',
                            data: res.data.data.columns
                        }]);
                        // if(res.data && res.data.data.columns) res.data.data.columns.map(function(c){
                        //     addItem(c)
                        // })
