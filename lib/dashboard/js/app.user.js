$(document).ready(function(){
    App.User = (function(){
        ...
        var gridElm;
        var URI = {
            binding : App.BaseUrl + 'api/user/bind',
            detail  : App.BaseUrl + 'api/user/detail',
            commit  : App.BaseUrl + 'api/user/commit',
            update  : App.BaseUrl + 'api/user/update',
            delete  : App.BaseUrl + 'api/user/delete'
        };
        var theme = 'metro';
