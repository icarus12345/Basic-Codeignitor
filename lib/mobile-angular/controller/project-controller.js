app.factory('StorageService', function(API) {
    this.set = function(name,id,val){
        var _storage = angular.fromJson(sessionStorage[name]||{});
        _storage[id] = val;
        sessionStorage[name] = angular.toJson(_storage);
    }
...
app.controller('ProjectController', function($rootScope, $scope, $route, $routeParams, API, CategoryService, ProjectService,StorageService) {
