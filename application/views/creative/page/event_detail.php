                ...
                <div class="banner-content">
                    <div>
                        <div class="breardcum">
                            ...
                            <?php endif; ?>
                            <span data-wow-delay="0.5s" class="wow fadeInUp"><?php echo $event_detail->title; ?></span>
                        </div>
                    </div>
                    <div data-wow-delay="1s" class="wow fadeInUp">
                        <div class="title"><?php echo $event_detail->title; ?></div>
                    </div>
                    <div class="line">
        ...
        <div class="detail-box">
                <div class="box-thumb">
                    <div class="nailthumb" >
                        <div class="nailthumb-container cover" style="background-image:url(<?php echo get_image_url($event_detail->data['image']); ?>)" data-anijs="if: scroll, on: window, do: zoomIn animated, before: scrollReveal">
                        </div>
                    </div>
                </div>
                <div class="box-text" >
                    <div class="hea">
                        <div class="title" data-fz="big" data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: removeAnim"><?php echo $event_detail->title; ?></div>
                    ...
                    <div class="desc scrollbar" data-fz="medium" data-anijs="if: scroll, on: window, do: slideInUp animated, before: scrollReveal, after: removeAnim">
                        <?php if($event_detail->longdata['content']): ?>
                        <?php echo $event_detail->longdata['content']; ?>
                        <?php else: ?>
        ...
        <div class="release-box">
            <div class="slogan" style="background:transparent" data-anijs="if: scroll, on: window, do: rollIn animated, before: scrollReveal">
                <div class="title" data-fz="bigger" >-- GỢI Ý TRÒ CHƠI CHO CÁC SỰ KIỆN --</div>
            ...
            <div class="release-slider">
                <div class="owl-carousel" id="owl-release">
                    ...
                    <?php foreach ($related_events as $key => $foo) : ?>
                    <div class="item box">
                        <div class="nailthumb">
                            ...
                            <div class="nailthumb-mark">
                                <div>
                                    ...
                                    <div class="author">CREATIVE DESIGN STUDIO</div>
                                    <div class="socials">
