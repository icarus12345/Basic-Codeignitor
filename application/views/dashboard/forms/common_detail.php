...
<form name="entry-detail-frm" id="entry-detail-frm" target="integration_asynchronous" class="validation-frm">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#entry-info-tab" aria-controls="entry-info-tab" role="tab" data-toggle="tab">Information</a>
        </li>
        <li role="presentation">
            <a href="#entry-seo-tab" aria-controls="entry-seo-tab" role="tab" data-toggle="tab">SEO</a>
        </li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="entry-info-tab">
        ...
        <div role="tabpanel" class="tab-pane" id="entry-seo-tab">
            <div class="-row -half seo-box ">
                <!-- <fieldset data-box="valid"> -->
                    ...
                    <div class="pull-bottom pull-top">
                        ...
                        <div class="control-group">
                            <input 
                                type="text" 
                                class="form-control validate[maxSize[120]]" 
                                placeholder="Title" name="data[seo_title]" 
                                value="<?php echo $entry_detail->data['seo_title'];?>" >
                        </div>
                    </div>
                    <div class="pull-bottom">
                        <div>Image :</div>
                        <div class="control-group">
                            <div class="input-append">
                                <input type="text" 
                                    class="form-control" 
                                    data-putto="#frm-err-seo_image"
                                    name="data[seo_image]"
                                    placeholder="Image"
                                    id="seo_image"
                                    value="<?php echo $entry_detail->data['seo_image'];?>"
                                    >
                                <span class="add-on" onclick="App.KCFinder.BrowseServer('#seo_image')">
                                    <i class="fa fa-image"></i>
                                </span>
                            </div>
                            <div id="frm-err-seo_image"></div>
                        </div>
                    </div>
                    <div class="pull-bottom">
                        <div>Desc :</div>
                        <div class="control-group">
                            <textarea 
                                type="text" 
                                class="form-control validate[maxSize[200]]" 
                                placeholder="Desc" name="data[seo_desc]"
                                ><?php echo $entry_detail->data['seo_desc'];?></textarea>
                        </div>
                    </div>
                    <div class="pull-bottom">
                        <div>Keywords :</div>
                        <div class="control-group">
                            <input 
                                type="text" 
                                class="form-control validate[maxSize[120]]" 
                                placeholder="Keyword" name="data[seo_keywords]" 
                                value="<?php echo $entry_detail->data['seo_keywords'];?>" >
                        </div>
                    </div>
                <!-- </fieldset> -->
            </div>
